export default function Home() {
    return (
        <div className="grid border-2 min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-white lg:grid-cols-[max(50%,36rem),1fr]">
            ...
            <main className="mx-auto w-full px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
                <div className="max-w-lg">
                    ...
                    <div className="mt-10">
                        <a href="#" className="text-sm font-semibold leading-7 text-teal-600"><span aria-hidden="true">&larr;</span> Back to home</a>
                    </div>
                </div>
            </main>
            ...
            <div className="hidden lg:relative lg:col-start-2 lg:row-start-1 lg:row-end-4 lg:block">
                <img src="https://images.newscientist.com/wp-content/uploads/2020/02/25113425/fnb1ej_web.jpg" alt="" className="absolute inset-0 h-full w-full object-cover"/>
            </div>
        </div>
    );
}